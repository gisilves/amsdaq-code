...
int main(int argc, const char *argv[])
{
  ...
  TH1F *hNclusS = new TH1F("hclusS", "hclusK", 10, -0.5, 9.5);
  hNclusS->GetXaxis()->SetTitle("n clusters");
  TH1F *hNclusK = new TH1F("hclusK", "hclusK", 10, -0.5, 9.5);
  hNclusK->GetXaxis()->SetTitle("n clusters");
  TH2F *hNclus2D = new TH2F("hclus2D", "hclus2D", 10, -0.5, 9.5, 10, -0.5, 9.5);
